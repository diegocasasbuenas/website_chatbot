...
export function HeartNode({ text = "Diego's Skills", onClick, className = "", style, size = 75 }: HeartNodeProps) {
  const scale = size / 75;
      ...
      >
        ...
        >
          <foreignObject x="-15.5" y="-19.5" width="124" height="112">
            <div
              style={{
                ...
                clipPath: "url(#bgblur_0_376_264_clip_path)",
                height: "100%",
                width: "100%",
              }}
            ></div>
          ...
          <g filter="url(#filter0_d_376_264)" data-figma-bg-blur-radius="24">
            <path
              d="M46.5 68C46.5 68 9 47.9545 9 24.3295C9 19.203 11.0514 14.2865 14.703 10.6615C18.3545 7.0365 23.3071 5 28.4712 5C36.6166 5 43.5938 9.40642 46.5 16.4545C49.4062 9.40642 56.3834 5 64.5288 5C69.6929 5 74.6455 7.0365 78.297 10.6615C81.9486 14.2865 84 19.203 84 24.3295C84 47.9545 46.5 68 46.5 68Z"
              fill="url(#paint0_linear_376_264)"
              shapeRendering="crispEdges"
            />
            <path
              d="M46.5 68C46.5 68 9 47.9545 9 24.3295C9 19.203 11.0514 14.2865 14.703 10.6615C18.3545 7.0365 23.3071 5 28.4712 5C36.6166 5 43.5938 9.40642 46.5 16.4545C49.4062 9.40642 56.3834 5 64.5288 5C69.6929 5 74.6455 7.0365 78.297 10.6615C81.9486 14.2865 84 19.203 84 24.3295C84 47.9545 46.5 68 46.5 68Z"
              stroke="url(#paint1_linear_376_264)"
              strokeLinecap="round"
        ...
        <span
          className="absolute text-white text-center font-general font-medium whitespace-nowrap"
          style={{
            top: "50%",
            left: "50%",
            transform: "translate(-50%, -50%)",
            fontSize: Math.max(Math.min(size * 0.22, 18), 12),
          }}
        >
          {text}
        </span>
