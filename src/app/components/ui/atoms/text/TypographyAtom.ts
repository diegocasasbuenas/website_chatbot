...
const variantStyles: Record<TypographyVariant, string> = {
  title:
    "text-white font-satoshi text-[clamp(44px,10vw,336px)] tracking-[clamp(-8.4px,-0.5vw,-1px)] font-black uppercase leading-none text-center",
  subtitle:
    "text-white font-satoshi text-[clamp(44px,6vw,336px)] tracking-[clamp(-8.4px,-0.2vw,-1px)] font-bold text-center",
